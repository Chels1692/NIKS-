    ...
    return (
        <main>
            <div className="products-page">
                <h1 className="products-title">Cleansers</h1>
                                    ...
                                    <div className="item-content">
                                        <ul>
                                            {filter.content.map((option, index) => (
                                                <li key={index}><input type="checkbox" name={filter.title} value={option.text} id={option.text}/><label for={option.text}>{option.text}</label></li>
                                            ))}
                                        </ul>
                                    </div>
                                </div>
